...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <br>
    <nav>
        <a style="font-family: raleway" href="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Casamentos</a>
 ...
 <div class="col-lg-6 col-md-6" id="inicio">
      ...
      <br>
      <p class="text-dark">O seu presente da maneira mais cômoda possível, o seu convidado compra um presente no nosso site e você recebem em dinheiro. Seja para qualquer tipo de evento, basta fazer o cadastro e fazer parte da nossa rede.
      <br>
      <br>
