...
<head>
  ...
  <!-- Folha de estilo Personalizada para Casamentos -->
  <link rel="stylesheet" type="text/css" href="{{asset('css/wedding.css')}}">
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-wedding fixed-top py-3" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">Nome do casal</a>
